 ...
 * @example GET /studentsGroups/:id/plan
 * @example GET /studentsGroups/:id/plan?from=2021-01-01&to=2021-12-31
 * @example GET /studentsGroups/:id/plan?from=2021-01-01
 * @example GET /studentsGroups/:id/plan?to=2021-12-31
 **/
